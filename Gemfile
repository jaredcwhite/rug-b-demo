...
gem "bridgetown-core", github: "bridgetownrb/bridgetown"
...
gem "bridgetown-lit-renderer", "~> 1.1", :group => :bridgetown_plugins, github: "bridgetownrb/bridgetown-lit-renderer", branch: "2-0-wip"
